        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row gap-8 px-4 md:px-8 lg:px-12">
                ...
                <div className="w-full lg:w-2/3 shadow-lg p-4">
                    <h1 className="text-4xl md:text-5xl font-bold">Plumber Breda</h1>
                    <div className="border-4 border-sky-400 w-28 my-10"></div>
                    <p className="text-gray-500 text-left text-lg md:text-xl space-y-8 my-4">
                        Plumber Breda 24 hour service: Are you looking for a plumber in Breda? Our professionals are available day and night, 7 days a week for all conceivable emergencies. Is your toilet clogged? Is the kitchen flooded by a burst water pipe? Or is your basement or crawl space flooded by a heavy rain shower? Don't panic and contact the Plumber Breda 24 hour service.
                        <br />
                    ...
                    <div className="flex flex-col md:flex-row my-8">
                        <div className="w-full md:w-1/2">
                            ...
                            <p className="text-gray-500 text-left text-lg md:text-xl space-y-4 my-4">
                                We only have well-trained and experienced plumbers working in Breda. If you call us for a leak or blocked sewer or blocked pipe, this will always be resolved as soon as possible.
                            </p>
                        </div>
                        <div className="w-full md:w-1/2 mt-6 md:mt-0">
                            <img className="h-60 md:h-80 w-full object-cover" 
                    ...
                    <p className="text-gray-500 text-left text-lg md:text-xl space-y-8 my-4">
                        ...
                        So are you looking for a plumber in the middle of the night? Or are you looking for a plumber on Saturday evening? No problem! You have come to the right place. Contact us by phone at 085 - 0026311 and get in touch with an employee of our plumbing company directly.
                    </p>

                    <h1 className="text-3xl font-bold text-sky-500 mt-10">24 hour Plumber in Clogged toilet in Breda</h1>
                    <p className="text-gray-500 text-left text-lg md:text-xl space-y-4 my-4">
                        ...
                        <br />
                        Call our service number 085 – 0026311 24/7 and get in direct contact with the plumber in Breda.
                    </p>
                </div>

                {/* Links div on the right */}
                <div className="w-full lg:w-1/3 pl-4 mt-10">
                    ...
                    <button className="btn my-6 mt-6 btn-info rounded-full py-2 px-8 text-2xl text-white w-full md:w-auto">
                        CALL: 085_0026311
                    </button>
