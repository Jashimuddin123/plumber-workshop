...
const TheHague = () => {
    return (
        ...
        <div className="flex flex-col md:flex-row shadow-2xl ml-12 px-6">
            ...
            <h1 className="text-5xl font-bold">Plumber The Hague</h1>
            <div className="border-4 border-sky-400 w-28 my-10"></div>
               <p className="text-gray-500 text-left text-xl space-y-8 my-4">Plumber The Hague 24 hour service : Are you looking for a plumber in The Hague? Our professionals are available day and night, 7 days a week for all conceivable emergencies. Is your toilet clogged? Is the kitchen flooded by a burst water pipe? Or is your basement or crawl space flooded by a heavy rain shower? Don't panic and contact the Plumber The Hague 24 hour service.

                 In addition to our emergency service, you can of course also contact us for less urgent matters, for example, do you want to have a new tap installed, a washing machine or dishwasher connected? Then contact our installation and maintenance service. Do you want to have your kitchen, toilet or bathroom renovated ? Then you have also come to the right place for these matters at our plumbing company.
                ...
                <div className="container flex flex-col md:flex-row">
                    <div className="text-content w-full md:w-1/2">
                        ...
                        The Hague Plumbers</h1>
                       <p className="text-gray-500 text-left text-xl space-y-4 my-4">We only have well-trained and experienced plumbers working in The Hague . If you call us for a leak or blocked sewer or blocked pipe, this will always be resolved as soon as possible.</p>
                       <div>
                    ...
                    Plumber The Hague Weekend</h1>
                    <p className="text-gray-500 text-left text-xl space-y-8 my-4">Our plumbing company in The Hague is also available on Saturdays and Sundays, 24 hours a day, 7 days a week we are ready for you. Every service technician has a well-equipped service car, in this way all problems can be solved quickly, professionally and expertly.
                    So are you looking for a plumber in the middle of the night? Or are you looking for a plumber on Saturday evening? No problem! You have come to the right place. Contact us by phone at 070-204 9001 and get in touch with an employee of our plumbing company directly.</p>

                   <h1 className=" text-3xl font-bold text-sky-500 mt-10">
                   Clogged toilet in The Hague</h1>
             <p className="text-gray-500 text-left text-xl space-y-4 my-4">Toilet clogged in The Hague? Or is there a blockage in the drain or sewer? Then make an appointment with one of our plumbers, we will come to you as soon as possible to solve the problem. We have tools for all blockages with us and ensure that your toilet or sewer is unclogged.

             Call our service number 085 – 0026311 24/7  and get in direct contact with the plumber in The Hague ..</p>
