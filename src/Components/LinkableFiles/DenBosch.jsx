...
const DenBosch = () => {
    return (
        ...
        <div className="flex flex-col md:flex-row shadow-2xl ml-12 px-6">
            ...
            <h1 className="text-5xl font-bold">Plumber Den Bosch</h1>
            <div className="border-4 border-sky-400 w-28 my-10"></div>
               <p className="text-gray-500 text-left text-xl space-y-8 my-4">Plumber Den Bosch 24 hour service : Are you looking for a plumber in Den Bosch? Our professionals are available day and night, 7 days a week for all conceivable emergencies. Is your toilet clogged? Is the kitchen flooded by a burst water pipe? Or is your basement or crawl space flooded by a heavy rain shower? Don't panic and contact the Plumber Den Bosch 24 hour service.

In addition to our emergency service, you can of course also contact us for less urgent matters, for example, do you want to have a new tap installed, a washing machine or dishwasher connected or do you want to have your kitchen, toilet or bathroom renovated ? Then you have also come to the right place for these matters at our plumbing company. You have also come to the right place for all installation and maintenance work .
...
You can reach us 24/7 via our free service number 085 – 0026311 , you will immediately get a professional on the line to make an appointment. Because our service engineers are spread throughout the region, we can almost always be on site very quickly.
                ...
                <div className="container flex flex-col md:flex-row">
                    <div className="text-content w-full md:w-1/2">
                        ...
                        Plumber Den Bosch</h1>
                       <p className="text-gray-500 text-left text-xl space-y-4 my-4">We only have well-trained and experienced plumbers working in Den Bosch . If you call us for a leak or blocked sewer or blocked pipe, this will always be resolved as soon as possible.</p>
                       <div>
                   ...
                   Clogged toilet in Den Bosch</h1>
