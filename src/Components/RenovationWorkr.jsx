        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row">
                ...
                <div className="flex-2 w-full lg:w-2/3 shadow-2xl ml-4 lg:ml-12 px-4 lg:px-6">
                    ...
                    <p className="text-left my-4 text-lg md:text-xl text-gray-500">Are you looking for a plumber who can carry out renovation work for you? Our plumbers can renovate your bathroom, renovate your toilet, but of course also replace pipes or drains. Feel free to contact our plumbers.
                    ...
                    <img className="w-full h-auto" src="https://i.ibb.co/8Y1xSfk/oie-Xa-Tn0nvm8b-Vc.jpg" alt="" />

                    <div>
                        <h1 className="text-3xl md:text-4xl font-bold my-4 text-sky-400 text-left">Renovation Work Bathroom</h1>
                        <p className="text-gray-500 text-lg md:text-xl my-4 text-left">When renovating the bathroom, it is important that the plumbing is replaced immediately. Make sure that new drains are installed and that the plumbing is replaced. You don't want to think about having to take everything out again because of a clogged drain or a burst water pipe when the bathroom renovation project is completed, do you? Contact our plumber completely free of charge, call 085 - 0026311 and get the plumber on the line immediately. He can tell you exactly what the possibilities are with regard to renovating the pipes during such a process.</p>
                        <h1 className="text-3xl md:text-4xl font-bold my-4 text-sky-400 text-left">Relocating pipes by plumber</h1>
                        <p className="text-gray-500 text-lg md:text-xl my-4 text-left">Do you want to relocate a pipe for example for a new kitchen that is going to be installed? Our plumbers can install new supplies for you. Also consider relocating existing pipes and moving the water taps. Of course we can also relocate a drain for example for the dishwasher.

                            In addition to moving or creating a water pipe, we can of course also be of service to you for creating or moving a gas pipe. Working with gas pipes naturally requires craftsmanship; of course, we only employ skilled and well-trained plumbers and gas fitters.
                        </p>

                    </div>

                    <img className="w-full h-96" src="https://i.ibb.co/16Fp88k/plumber-conteiner.jpg" alt="" />
                    ...
                    <p className="text-gray-500 text-left text-lg md:text-xl my-4">
                        Do you have a leak in your home due to a burst pipe or have you hit a water pipe with a drill or a milling machine while doing odd jobs in your home? Then make sure you find the main tap in your home as soon as possible. You will often find this main water pipe at your water meter in the meter cupboard, basement, or in the crawl space. In older homes, these water meters can also be found in a kitchen cupboard or in the bathroom.
                    </p>
                    <p className="text-gray-500 text-left mb-4 text-lg md:text-xl my-4">We also do not shy away from larger projects; our professionals can therefore often be found at large new construction projects or large-scale renovation projects of, for example, a housing association. Partly due to these projects, our plumbers gain a great deal of experience that every subsequent customer benefits from! Are you currently a project developer? Or do you have questions about what we can do for you? Then please call us on the service number 085 - 0026311.

                        Contact our 24-hour Plumber service day and night on telephone number 085 – 0026311 and get a plumber on the line immediately.
                    </p>
                </div>
