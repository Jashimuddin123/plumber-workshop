    ...
    return (
        <div className="flex flex-col p-4 lg:p-8">
            ...
            <div className="text-right mb-4">
                <h2 className="my-4 lg:mr-8 text-lg">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="w-full lg:w-2/3 shadow-2xl px-4 lg:px-6">
                    <h1 className="text-4xl lg:text-5xl font-bold">Sewerage</h1>
                    <div className="border-2 border-sky-400 w-28 my-6"></div>
                    <img className="w-full" src="https://i.ibb.co/SRfvZXn/24uurloodgieter-baner-slide1.jpg" alt="Sewerage Service" />
                    <button className="btn my-4 btn-info text-white rounded-full text-xl py-2 px-4">CALL URGENTLY: 085_0026311</button>
                    <h1 className="text-3xl lg:text-4xl font-bold my-4 text-left">Sewer problems?</h1>
                    <p className="text-lg lg:text-xl my-4 text-gray-500 text-left">
                        Is your sewer blocked? Is the water no longer draining? Contact our 24-hour Plumber service. We are available day and night for all conceivable sewer problems.
                    </p>
                    <img className="w-full" src="https://i.ibb.co/bsvFvkt/waterpipe-lig.jpg" alt="Water Pipe" />

                    <div>
                        <h1 className="text-3xl my-6 font-bold text-sky-400 text-left">Sewerage works</h1>
                        <h1 className="text-gray-600 text-left text-lg lg:text-xl">You can contact us 24/7 for:</h1>
                        <ul className="ml-6 text-lg lg:text-xl mb-8 space-y-4 text-gray-500 list-disc mt-4">
                    ...
                    <div className="flex flex-col lg:flex-row lg:gap-10">
                        <div className="w-full lg:w-1/2">
                            ...
                            <p className="text-gray-500 text-left text-lg lg:text-xl my-4">
                                A common problem is a clogged toilet, often caused by excessive use of toilet paper...
                            </p>
                            <p className="text-gray-500 text-left text-lg lg:text-xl my-4">
                                In addition, various liquid or non-liquid drain unblockers can cause major damage to the sewer or drain...
                            </p>
                        </div>
                        <div className="w-full lg:w-1/4 mt-4 lg:mt-0">
                            <img className="w-full h-60 lg:h-96" src="https://i.ibb.co/tYPYh1r/24-loodgieter-181x300.jpg" alt="Clogged Sewer" />
                        </div>
                    </div>
                    ...
                    <div>
                      ...
                      Our plumbers have various items in their standard tools to clear the sewer again, we also have enough tools and expertise to clear a drain!</p>
                        <h1 className="text-2xl font-bold text-sky-400 text-left">Unblocking the sewer by the plumber</h1>
                        <p className="text-left text-lg md:text-xl my-4 text-gray-500">
                        ...
                        <h1 className="text-2xl font-bold text-sky-400 text-left">Plumber 24 hours sink clogged</h1>
                        <p className="text-left text-lg md:text-xl my-4 text-gray-500">
                  ...
                  Our plumbing company has a large working area, are you looking for a  plumber in Den Bosch , a  plumber in Amsterdam ,  a  plumber in Rotterdam , a  plumber in Breda  or are you looking for a  plumber in Utrecht ? We work in all large and small cities in  Utrecht ,  Brabant ,  South Holland  and  North Holland . We offer day and night service and can always be on site quickly in case of direct emergencies.
                   ...
                   Want to speak to a certified plumber right away? Call our free service number 085 – 0026311 24 hours a day, 7 days a week and get one of our employees on the line right away.</p>
                        <img className="w-full h-60 lg:h-[500px]" src="https://i.ibb.co/bsvFvkt/waterpipe-lig.jpg" alt="Water Pipe" />
                    </div>
                </div>
